    ...
    <div class="header">
      <van-nav-bar :border="false" left-arrow @click-left="back()">
        <van-dropdown-menu slot="title">
          <van-dropdown-item v-model="title" :options="titleOption" @change="getList()" />
        </van-dropdown-menu>
        <van-icon
            ...
            <div class="item" @click="goDetail(item.id,item.is_sell,item.is_out)">
              ...
              <div style="flex: 1;">
                <van-row>
                  ...
                  <van-col span="7" class="price">￥{{(tab==0)?item.rent.price:item.price}}</van-col>
                </van-row>
                <van-row>
